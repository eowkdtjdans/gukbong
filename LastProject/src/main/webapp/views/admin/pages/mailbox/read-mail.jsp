		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-3">
							<a href="mailbox.jsp" class="btn btn-primary btn-block mb-3">Back
								to Inbox</a>
							...
							<div class="card">
								...
								<div class="card-body p-0">
									<ul class="nav nav-pills flex-column">
										<li class="nav-item"><a href="mailbox.jsp"
											class="nav-link"> <i class="fa fa-inbox"></i> Inbox <span
							...
							<div class="card">
								...
								<div class="card-body p-0">
									<ul class="nav nav-pills flex-column">
										...
										<li class="nav-item"><a class="nav-link" href="#"><i
												class="fa fa-circle-o text-primary"></i> Social</a></li>
									</ul>
								</div>
								<!-- /.card-body -->
							</div>
										...
										<li><span class="mailbox-attachment-icon"><i
											...
											<div class="mailbox-attachment-info">
												<a href="#" class="mailbox-attachment-name"><i
													...
													href="#" class="btn btn-default btn-sm float-right"><i
