			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview menu-open"><a href="#"
							class="nav-link active"> <i class="nav-icon fa fa-pie-chart"></i>
								<p>
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a href="flot.jsp" class="nav-link">
										<i class="fa fa-circle-o nav-icon"></i>
										<p>Flot</p>
								</a></li>
								<li class="nav-item"><a href="inline.jsp"
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">
										<i class="fa fa-bar-chart-o"></i> jQuery Knob
									</h3>
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">
										<i class="fa fa-bar-chart-o"></i> jQuery Knob Different Sizes
									</h3>
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">
										<i class="fa fa-bar-chart-o"></i> jQuery Knob Tron Style
									</h3>
							...
							<div class="card">
								...
								<div class="card-body text-center">
									<div class="sparkline" data-type="bar" data-width="97%"
										...
										data-bar-Color="#f39c12">6,4,8, 9, 10, 5, 13, 18, 21, 7,
										9</div>
								</div>
								<!-- /.card-body -->
							</div>
	...
	<script>
		...
		function drawDocSparklines() {
			...
			$('#compositebar').sparkline(
					[ 4, 1, 5, 7, 9, 9, 8, 7, 6, 6, 4, 7, 8, 4, 3, 2, 2, 5, 6,
							7 ], {
						composite : true,
						fillColor : false,
						lineColor : 'red'
		...
		function drawMouseSpeedDemo() {
			...
			$('html').mousemove(
					function(e) {
						...
						var mousey = e.pageY
						if (lastmousex > -1) {
							mousetravel += Math.max(Math.abs(mousex
									- lastmousex), Math
			...
			var mdraw = function() {
				...
				if (lastmousetime && lastmousetime != timenow) {
					var pps = Math.round(mousetravel
							/ (timenow - lastmousetime) * 1000)
					mpoints.push(pps)
