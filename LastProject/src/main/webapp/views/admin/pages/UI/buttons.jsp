					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary card-outline">
								<div class="card-header">
									<h3 class="card-title">
										<i class="fa fa-edit"></i> Outline Buttons
									</h3>
								</div>
								<div class="card-body pad table-responsive">
									<p>
						...
						<div class="col-md-6">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<button type="button"
										class="btn btn-default btn-block btn-flat">.btn-block
										.btn-flat</button>
						...
						<div class="col-md-6">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									</a> <a class="btn btn-app"> <i class="fa fa-repeat"></i>
										Repeat
									</a> <a class="btn btn-app"> <i class="fa fa-pause"></i> Pause
									</a> <a class="btn btn-app"> <i class="fa fa-save"></i> Save
									</a> <a class="btn btn-app"> <span class="badge bg-warning">3</span>
										<i class="fa fa-bullhorn"></i> Notifications
									</a> <a class="btn btn-app"> <span class="badge bg-success">300</span>
									...
									</a> <a class="btn btn-app"> <span class="badge bg-info">12</span>
										<i class="fa fa-envelope"></i> Inbox
									</a> <a class="btn btn-app"> <span class="badge bg-danger">531</span>
