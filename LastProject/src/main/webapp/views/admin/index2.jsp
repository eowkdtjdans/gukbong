...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
									...
									<div class="d-md-flex">
										<div class="p-1 flex-1" style="overflow: hidden">
											...
											<div id="world-map-markers"
												style="height: 325px; overflow: hidden"></div>
										</div>
									...
									<div class="row">
										...
										<div class="col-md-4">
											<ul class="chart-legend clearfix">
												...
												<li><i class="fa fa-circle-o text-secondary"></i>
													Navigator</li>
											</ul>
										</div>
										<!-- /.col -->
									...
									<ul class="nav nav-pills flex-column">
										<li class="nav-item"><a href="#" class="nav-link">
												...
												class="float-right text-danger"> <i
													class="fa fa-arrow-down text-sm"></i> 12%
											</span>
										</a></li>
										<li class="nav-item"><a href="#" class="nav-link">
												India <span class="float-right text-success"> <i
													class="fa fa-arrow-up text-sm"></i> 4%
											</span>
										</a></li>
										<li class="nav-item"><a href="#" class="nav-link">
												China <span class="float-right text-warning"> <i
													class="fa fa-arrow-left text-sm"></i> 0%
											</span>
										</a></li>
									</ul>
								</div>
		...
		<footer class="main-footer">
			<!-- To the right -->
			<div class="float-right d-sm-none d-md-block">Anything you want
			</div>
			<!-- Default to the left -->
